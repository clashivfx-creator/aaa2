...
export const AnimatedBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 w-full h-full overflow-hidden pointer-events-none -z-10 bg-black">
      ...
      <div className="absolute -top-[10%] -left-[10%] w-[80vw] h-[80vw] rounded-full mix-blend-screen opacity-30 animate-drift blur-[100px]"
           style={{ background: 'radial-gradient(circle, rgba(147, 51, 234, 0.5) 0%, rgba(88, 28, 135, 0) 70%)' }} />

      {/* Deep Blue Depth - Top Right */}
      <div className="absolute top-[0%] right-[0%] w-[70vw] h-[70vw] rounded-full mix-blend-screen opacity-20 animate-drift-slow blur-[120px]"
           style={{ background: 'radial-gradient(circle, rgba(59, 130, 246, 0.4) 0%, rgba(30, 58, 138, 0) 70%)' }} />

      {/* Pink/Magenta Accent - Bottom Left */}
      <div className="absolute bottom-[0%] -left-[10%] w-[70vw] h-[70vw] rounded-full mix-blend-screen opacity-20 animate-drift-slower blur-[100px]"
           style={{ background: 'radial-gradient(circle, rgba(236, 72, 153, 0.4) 0%, rgba(131, 24, 67, 0) 70%)' }} />

      {/* Cyan/Green Hint - Bottom Right */}
      <div className="absolute -bottom-[10%] right-[0%] w-[60vw] h-[60vw] rounded-full mix-blend-screen opacity-10 animate-drift blur-[80px]"
           style={{ background: 'radial-gradient(circle, rgba(16, 185, 129, 0.3) 0%, rgba(6, 78, 59, 0) 70%)' }} />
      ...
      <div
        ...
        style={{
          ...
          animation: 'float-center 25s ease-in-out infinite'
        }}
      />
