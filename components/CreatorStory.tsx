      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="space-y-8 text-gray-300 text-xl leading-relaxed mb-12 font-light max-w-3xl mx-auto">
            ...
            <FadeIn delay={400}>
              <p>
                Hoy, he trabajado con <strong className="text-white font-medium text-2xl block mt-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.15)]">Rauw Alejandro, Emilia Mernes, Duki, Khea, Kun Agüero, YSY A, Thiago PZK, Lit Killah, y muchos más.</strong>
              </p>
            </FadeIn>
          ...
          <FadeIn delay={800}>
            <a href="https://e08ff1-xx.myshopify.com/" target="_blank" rel="noopener noreferrer">
              <Button className="!px-16 !py-8 !text-2xl !font-bold !bg-none !bg-green-500 hover:!bg-green-400 !text-white !border-none shadow-[0_0_40px_rgba(34,197,94,0.6)] hover:shadow-[0_0_60px_rgba(34,197,94,0.8)] transform hover:scale-105 transition-all duration-300">
                  Toda la tienda
              </Button>
            </a>
          </FadeIn>
